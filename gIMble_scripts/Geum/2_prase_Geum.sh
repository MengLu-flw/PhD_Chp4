#!/bin/bash
#SBATCH --job-name="2_Geum_parse"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Geum/Slurm/Geum_parse.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Geum/Slurm/Geum_parse.err"
...
# cp /home/mlu/projects/rbge/mlu/4_gimble_v2/Geum/gimble.nucl.genomefile ./
...
# cp /home/mlu/projects/rbge/mlu/4_gimble_v2/Geum/gimble.popID.samples.csv ./
...
time gimble parse -v gimble.vcf.gz -b gimble_GeuUrba_masked.bed -g gimble.nucl.genomefile -s gimble.popID.samples.csv -z Geum_Gstore #-f
...
#-3- GeuUrba_masked_gimble.bed >>> which soft-masked the genome
