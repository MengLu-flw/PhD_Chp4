#!/bin/bash
#SBATCH --job-name="9_Geum_makeGrid"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Geum/Slurm/9_Geum_makeGrid.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Geum/Slurm/9_Geum_makeGrid.err"
