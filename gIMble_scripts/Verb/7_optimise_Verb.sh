#!/bin/bash
#SBATCH --job-name="7_Verb_optimize64"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Verb/Slurm/7_Verb_optimize64.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Verb/Slurm/7_Verb_optimize64.err"
...
gimble optimize -z Verb_Gstore.z -d tally/windows_kmax2 -w \
                -g CRS2 -e 19 -i 10000 \
                -r A -u 7e-09 \
                -A 1_000,1_500_000 -B 1_000,1_500_000 \
                -C 50_000,5_000_000 -T 100_000,5_000_000 \
                -m DIV \
                -l DIV_wkmax2
