#!/bin/bash
#SBATCH --job-name="7_PrimDToL_optimize"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Prim_DToL/Slurm/7_PrimDToL_optimize.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Prim_DToL/Slurm/7_PrimDToL_optimize.err"
...
gimble optimize -z PrimDToL_Gstore.z -d tally/windows_kmax2 -w \
                -g CRS2 -e 40 -i 10000 \
                -r A -u 7e-09 \
