#!/bin/bash
#SBATCH --job-name="7_Geum_optimize64"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Geum/Slurm/7_Geum_optimize64.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Geum/Slurm/7_Geum_optimize64.err"
...
gimble optimize -z Geum_Gstore.z -d tally/windows_kmax2 -w \
                -g CRS2 -e 29 -i 10000 \
                -r A -u 7e-09 \
