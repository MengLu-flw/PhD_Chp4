#!/bin/bash
#SBATCH --job-name="7_Viol_optimize64"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Viol/Slurm/7_Viol_optimize64.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Viol/Slurm/7_Viol_optimize64.err"
...
gimble optimize -z Viol_Gstore.z -d tally/windows_kmax2 -w \
                -g CRS2 -e 19 -i 10000 \
                -r A -u 7e-09 \
                -A 1_000,90_000 -B 1_000,90_000 \
                -C 50_000,1_000_000 -T 100_000,1_000_000 \
                -m DIV \
                -l DIV_wkmax2 -f
                # if you want to rerun, use -f
...
gimble optimize -z Viol_Gstore.z -d tally/windows_kmax2 -w \
                ...
                -r A -u 7e-09 \
                -A 1_000,90_000 -B 1_000,90_000 \
                -C 50_000,1_000_000 -T 100_000,5_000_000 \
                -M 0,5e-05 -m IM_AB \
                -l IM_AB_wkmax2 -f
                #-f
