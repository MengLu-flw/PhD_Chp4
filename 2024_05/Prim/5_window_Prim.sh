#!/bin/bash
#SBATCH --job-name="5_Prim_ex_window"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Prim/Slurm/5_Prim_ex_window.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Prim/Slurm/5_Prim_ex_window.err"
...
time gimble windows -z Prim_POP.z -w 223440 -s 44688
