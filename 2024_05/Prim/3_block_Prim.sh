...
#!/bin/bash
#SBATCH --job-name="3_Prim_ex_block"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Prim/Slurm/3_Prim_ex_block.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Prim/Slurm/3_Prim_ex_block.err"
...
time gimble blocks -z Prim_POP.z -l 64 # if you are rerunning this, use '--force' to force overwrite of existing data
