#!/bin/bash
#SBATCH --job-name="7_Prim_optimize"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Prim/Slurm/7_Prim_optimize.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Prim/Slurm/7_Prim_optimize.err"
...
gimble optimize -z Prim_Gstore.z -d tally/windows_kmax2 -w \
                -g CRS2 -e 40 -i 10000 \
                -r A -u 7e-09 \
...
gimble optimize -z Prim_Gstore.z -d tally/windows_kmax2 -w \
                ...
                -r A -u 7e-09 \
                -A 10_000,100_000 -B 10_000,100_000 \
                -C 100_000,900_000 -T 260_000,5_000_000 \
                -M 0,5e-05 -m IM_AB \
                -l IM_AB_wkmax2
                #-f
