#!/bin/bash
#SBATCH --job-name="2_PrimDToL_ex_parse"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Prim_DToL/Slurm/2_PrimDToL_ex_parse.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Prim_DToL/Slurm/2_PrimDToL_ex_parse.err"
...
# cp gimble.genomefile gimble.nucl.genomefile
# gimble.nucl.genomefile (keep the top 11 main chromosomes)
# wc gimble.nucl.genomefile
...
time gimble parse -v gimble.vcf.gz -b gimble_PriVulg_masked.bed -g gimble.nucl.genomefile -s gimble.popID_ex.samples.csv -z PrimDToL_POP
